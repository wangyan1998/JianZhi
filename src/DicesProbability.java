...
public class DicesProbability {
    /**
     * 假设已知n−1个骰子的解f(n−1)，此时添加一枚骰子，求n个骰子的点数和为 x的概率f(n,x) 。
     * 当添加骰子的点数为 1时，前 n−1个骰子的点数和应为x−1，方可组成点数和 x；同理，当此
     * 骰子为2时，前n−1个骰子应为x−2；以此类推，直至此骰子点数为6。将这 6种情况的概率相加，
     * 即可得到概率f(n,x)。递推公式如下所示：
